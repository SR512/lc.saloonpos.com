                    ...
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="text-white-50 mb-0">Get your free {{config('constants.APP_NAME')}} account now</p>
...
{{--                                    </div>--}}
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <p>© <script>
                            ...
                            </script> {{config('constants.APP_NAME')}}. Crafted with <i class="mdi mdi-heart text-danger"></i> by {{config('constants.DEVELOPED_BY')}}</p>
                    </div>
