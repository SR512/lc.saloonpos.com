...
@section('content')
    ...
    @component('common-components.breadcrumb',['li_1'=>['Dashboard'=>route('home'),'Expense List' =>route('expense.index') ]])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br/>
                    {!! Form::open(['url' => route('expenses.update',$expense->id),'id'=>'edit-expense-form']) !!}
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('expenses_name', 'Expenses name', ['class' => 'col-form-label']); !!}
                                {!! Form::text('expenses_name',$expense->expenses_name,['class' => 'form-control']); !!}
                                @error('expenses_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::date('date',$expense->date,['class' => 'form-control','max'=>date('Y-m-d',strtotime(\Carbon\Carbon::now()))]); !!}
                                @error('date')
                                <span style="color:red">
                                    {{$message}}
                               </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::number('amount',$expense->amount,['class' => 'form-control','max'=>'10']); !!}
                                @error('pin_code')
                                <span style="color:red">
                                    {{$message}}
                               </span>
