        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br/>
                    {!! Form::open(['url' => route('appointments.update',$appointment->id),'id'=>'appointment-form',]) !!}
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('customer_id', 'Customer', ['class' => 'col-form-label']); !!}
                                {!! Form::select('customer_id',$customers,$appointment->customer_id,['class' => 'form-control','placeholder'=>'Select customer']); !!}
                                @error('first_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('service_id',$services,$appointment->service_id,['class' => 'form-control','placeholder'=>'Select service']); !!}
                                @error('service_id')
                                <span style="color:red">
                                    {{$message}}
                               </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('employee_id',$employees,$appointment->employee_id,['class' => 'form-control','placeholder'=>'Select employee']); !!}
                                @error('first_name')
                                <span style="color:red">
                                    {{$message}}
                               </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::datetimeLocal('appointment_date_time',date('Y-m-d\TH:i',strtotime($appointment->appointment_date_time)),['class' => 'form-control','max'=>date('Y-m-d',strtotime(\Carbon\Carbon::now()))]); !!}
                                @error('date_of_birth')
                                <span style="color:red">
                                    {{$message}}
                               </span>
