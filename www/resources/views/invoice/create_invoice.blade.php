...
@section('content')
    ...
    @component('common-components.breadcrumb',['li_1'=>['Dashboard'=>route('home'),'Invoice List' =>route('invoice.index') ]])
        @slot('title') New Invoice  @endslot
    @endcomponent
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br/>
                    {!! Form::open(['url' => route('invoices.store'),'id'=>'invoice-form','method'=>'post']) !!}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('name','',['class' => 'form-control customer-name','placeholder'=>'Seach Customer Name or Enter . . .','required'=>true]); !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\InvoiceRequest', '#invoice-form'); !!}
@endsection
