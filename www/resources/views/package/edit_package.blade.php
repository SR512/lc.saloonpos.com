        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br/>
                    {!! Form::open(['url' => route('packages.update',$package->id),'id'=>'package-form']) !!}
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('packagename', 'Package name', ['class' => 'col-form-label']); !!}
                                {!! Form::text('packagename',$package->packagename,['class' => 'form-control']); !!}
                                @error('packagename')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::number('duration',$package->duration,['class' => 'form-control']); !!}
                                @error('duration')
                                <span style="color:red">
                                    {{$message}}
                               </span>
                    ...
                    <div class="row">
                                                ...
                                                <select class="form-control product-size"
                                                    ...
                                                    @if(!empty($services))
                                                        ...
                                                        @foreach($services as $service)
                                                            <option
                                                                value="{{$service->service_name}}" {{$row->size == $service->service_name ?'selected':''}}>{{$service->service_name}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </td>
                                            <td><input type="number"  class="form-control"
                                                       name="product[detail][{{$key}}][qty]"  value="{{$row->qty}}"placeholder="Qty" required>
                                            </td>
                                            <td>
                                                <button class="btn btn-danger medicine-delete"><i
                                                        class="fa fa-trash"></i>
                                                </button>
                                            </td>
                                        </tr>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::number('totalprice',$package->totalprice,['class' => 'form-control']); !!}
                                @error('totalprice')
                                <span style="color:red">
                                    {{$message}}
                               </span>
